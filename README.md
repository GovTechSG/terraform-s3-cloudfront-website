...
| <a name="input_nonce_injection_config"></a> [nonce\_injection\_config](#input\_nonce\_injection\_config) | Configuration for nonce injection when enable_nonce is true. Controls which types of HTML tags receive nonces. | `object({ inject_script_nonces = bool, inject_style_nonces = bool })` | `{ inject_script_nonces = true, inject_style_nonces = true }` | no |
